...
const nextConfig = {
   ...
   */
  basePath: process.env.NODE_ENV === 'production' ? '/01-hello-world' : '', // update if your repo name changes for 'npm run deploy' to work correctly
  assetPrefix: process.env.NODE_ENV === 'production' ? '/01-hello-world/' : '', // update if your repo name changes for 'npm run deploy' to work correctly
};
